...
C     ALL UNITS SI  (M,KG,S,C,K,J,PA)
      ...
      DOUBLE PRECISION NUTOTAL,SHFREE,SHFORC,CONV_ENHANCE
      DOUBLE PRECISION G_VS_AB,G_VS_AD,O2GAS,CO2GAS,N2GAS
      
      INTEGER GEOMETRY,NODNUM,WINGCALC,WINGMOD,IHOUR,LEAF,ORIENT
...
C     CONV_ENHANCE = CONVECTIVE ENHANCEMENT FACTOR (SEE MITCHELL 1979 https://doi.org/10.1016/S0006-3495(76)85711-6)
...
C     GET THERMAL PROPERTIES OF DRY AIR AT CURRENT TEMP AND PRESSURE
       CALL DRYAIR(DB,BP,ALT,PATMOS,O2GAS,N2GAS,CO2GAS,DENSTY,VISDYN,
     *  VISKIN,DIFVPR,THCOND,HTOVPR,TCOEFF,GGROUP)
...
C  **************************************************************************
   40 CONTINUE
      HCFORC=CONV_ENHANCE*ANU*THCOND/D ! HEAT TRANFER COEFFICIENT
      SHFORC=CONV_ENHANCE*ANU*(SC/PR)**(1./3.) ! SHERWOOD NUMBER
...
C     USING BIRD, STEWART, & LIGHTFOOT'S MIXED CONVECTION FORMULA (P. 445, TRANSPORT PHENOMENA, 2002)
      NUTOTAL=(ANUFRE**3.+(CONV_ENHANCE*ANU)**3.)**(1./3.)
