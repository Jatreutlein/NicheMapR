...
C     THERE IS NOT THE SAME EXCHANGE BETWEEN LEGS AND THE BODY YOU HAVE WITH IR.
      ...
      SUBROUTINE SOLAR_ENDO(AREATOTL,AREACOND,ABSAND,ABSANV,ABSSB,ASIL,
     &PCTDIF,QNORM,ASHADE,QSOLR,FASKY,FAVEG,RESULTS)
     
      IMPLICIT NONE

      DOUBLE PRECISION ABSAND,ABSANV,ABSSB,AREACOND,AREATOTL,ASHADE,ASIL
      DOUBLE PRECISION FASKY,FAVEG,PCTDIF,QDORSL,QNORM,QSDIFF,QSDIR
...
C     QSRSB=ABSANV*FAGRD*AREATOTL*(1.0-ABSSB)*QSOLR*(100.-ASHADE)/100.
      QSRSB=ABSANV*(1.-FASKY-FAVEG)*(AREATOTL-AREACOND)*
