...
C     ZFUR = FUR DEPTH
     ...
     &VEL,ZFUR,BP,ALT,CONV_ENHANCE,GRAV,O2GAS,N2GAS,CO2GAS,RESULTS)
...
C     COMBINED FORCED & FREE
      !HD=HDFORC+HDFREE ! this was in pre 2025 versions but better to combine them as for heat transfer
      SHCOMB = NUTOTAL * (SC/PR)**.333
      HD = SHCOMB*DIFVPR/D
