...
C     SOLVING THE HEAT AND WATER BALANCES, GIVEN THE CHOSEN GEOMETRY
      ...
      DOUBLE PRECISION CUSTOMGEOM,CUTFA,D,DEPSUB,EGGSHP,EMISAN,EMISSB
      DOUBLE PRECISION EMISSK,F12,F13,F14,F15,F16,F21,F23,F24,F25,F26
      DOUBLE PRECISION F31,F32,F41,F42,F51,F52,F61,FATCOND,FATOBJ,FATOSB
      DOUBLE PRECISION FATOSK,FLSHCOND,FLUID,G,GMASS,H2O_BALPAST,HC,HD
      DOUBLE PRECISION HDFORC,HDFREE,NEWDEP,P,PANT,PANTMAX,PDIF
      ...
      DOUBLE PRECISION WRESP,ZEN,RAINMULT,EGGPTCOND,POT,CONV_ENHANCE
      DOUBLE PRECISION TLUNG,DELTAR,EXTREF,RQ,MR_1,MR_2,MR_3,MR_4
     ...
     & PAS,PBS,PCS,PDS,PGS,PJS,PMS,PRS,WETFOOD      
      DOUBLE PRECISION STAGE,RAINDRINK,G_VS_AB,G_VS_AD
      DOUBLE PRECISION POTFREEMASS,GUTFREEMASS,CO2FLUX,O2FLUX,MU_N
      DOUBLE PRECISION CLUTCHSIZE,ANDENS_DEB,D_V,EGGDRYFRAC,W_E,MU_E,
     & MU_V,W_V,E_EGG,KAP_V,KAP_X,KAP_X_P,MU_X,MU_P,W_N,W_P,W_X,FUNCT
     
      INTEGER CONTONLY,CONTYPE,GEOMETRY,IHOUR,LIVE,MICRO,NM
      INTEGER NODNUM,POND,WETMOD,WINGCALC,WINGMOD
      INTEGER RAINHOUR,VIVIPAROUS,PREGNANT,DEB1,CENSUS,
     & RESET,DEADEAD,STARTDAY,DEAD,EGGMULT,LEAF,ORIENT
     ...
     & W_V,E_EGG,KAP_V,KAP_X,KAP_X_P,MU_X,MU_P,W_N,W_P,W_X,FUNCT,MU_N
      ...
      IF((DEB1.EQ.1).AND.(STAGE.EQ.0.).AND.
     & (EGGMULT.EQ.1))THEN
