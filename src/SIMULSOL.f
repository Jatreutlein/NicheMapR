...
C     FLTYPE = FLUID TYPE: 0 = AIR; 1 = FRESH WATER; 2 = SALT WATER
     ...
     & ,ENVVARS,TRAITS,TFA,SKINW,TSKIN,RESULTS)
      ...
      DOUBLE PRECISION TRAITS,TRAPPX,TSKCALC,TSKCALC1
      ...
      DIMENSION GEOMVARS(21) ! SHAPE,SUBQFAT,SURFAR,VOL,D,CONVAR,CONVSK,RFUR,RFLESH,RSKIN,XR,RRAD,ASEMAJ,BSEMIN,CSEMIN,CD,
