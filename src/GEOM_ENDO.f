...
C     EFFECTIVE AREA OF SKIN THAT IS WET).
      ...
      SUBROUTINE GEOM_ENDO(AMASS,ANDENS,FATDEN,FATPCT,SHAPE,ZFUR,SUBQFAT
...
C     FLAT PLATE
      IF (INT(SHAPE) .EQ. 3) THEN
       ...
       ASILN = max((AWIDTH+ZFUR*2.) * (ALENTH+ZFUR*2.), 
     &  (ALENTH+ZFUR*2.) * (AHEIT+ZFUR*2.), 
     & (AWIDTH+ZFUR*2.) * (AHEIT+ZFUR*2.))
       ASILP = min((AWIDTH+ZFUR*2.) * (ALENTH+ZFUR*2.), 
     &  (ALENTH+ZFUR*2.) * (AHEIT+ZFUR*2.), 
     & (AWIDTH+ZFUR*2.) * (AHEIT+ZFUR*2.))
