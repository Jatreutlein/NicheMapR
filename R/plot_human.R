...
plot_human <- function(
  ...
  SAMODE <- 0
  GEOM.head <- GEOM_ENDO(MASSs[1], DENSITYs[1], DENSITYs[1], FATPCTs[1], SHAPEs[1], INSDEPDs[1], SUBQFATs[1], SHAPE_Bs[1], SHAPE_Bs[1], DHAIRDs[1], INSDENDs[1], PJOINs[1], SAMODE, ORIENTs[1], ZEN = 90)
  GEOM.trunk <- GEOM_ENDO(MASSs[2], DENSITYs[2], DENSITYs[2], FATPCTs[2], SHAPEs[2], INSDEPDs[2], SUBQFATs[2], SHAPE_Bs[2], SHAPE_Bs[2], DHAIRDs[2], INSDENDs[2], PJOINs[2], SAMODE, ORIENTs[2], ZEN = 90)
  GEOM.arm <- GEOM_ENDO(MASSs[3], DENSITYs[3], DENSITYs[3], FATPCTs[3], SHAPEs[3], INSDEPDs[3], SUBQFATs[3], SHAPE_Bs[3], SHAPE_Bs[3], DHAIRDs[3], INSDENDs[3], PJOINs[3], SAMODE, ORIENTs[3], ZEN = 90)
  GEOM.leg <- GEOM_ENDO(MASSs[4], DENSITYs[4], DENSITYs[4], FATPCTs[4], SHAPEs[4], INSDEPDs[4], SUBQFATs[4], SHAPE_Bs[4], SHAPE_Bs[4], DHAIRDs[4], INSDENDs[4], PJOINs[4], SAMODE, ORIENTs[4], ZEN = 90)
